...
#else
  printf("cat_dog_score = %d\n", cat_dog_score);
  if (cat_dog_score < 128) {
    printf("It's Cat (confidence = %d/100)\n", ((128 - cat_dog_score) * 100) / 128);
  } else {
    printf("It's a dog (confidence = %d/100)\n", ((cat_dog_score - 128) * 100) / 128);
  }
#endif
}
